...
{
    /// <inheritdoc />
    public partial class InialTables : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PricePerKilometer = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    DriverSupport = table.Column<bool>(type: "bit", nullable: false),
                    ...
                    TypeId1 = table.Column<byte>(type: "tinyint", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Decorations_Vehicles_VehicleId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DriverIncluded = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RentalDecorations", x => new { x.RentalId, x.DecorationId });
                    table.ForeignKey(
                        name: "FK_RentalDecorations_Decorations_DecorationId",
                        column: x => x.DecorationId,
                        principalTable: "Decorations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RentalDecorations_Rentals_RentalId",
                        column: x => x.RentalId,
                        principalTable: "Rentals",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RentalDecorations_DecorationId",
                table: "RentalDecorations",
                column: "DecorationId");
